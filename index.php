...
<div class="row mt-3">
    <div class="col-lg-3 mb-3">
        <div class="card small mb-3">
            <div class="card-header p-2">
                <div class="card-tittle"><i class="far fa-file mr-1"></i> Informasi Struk</div>
            </div>
            <div class="card-body p-2">
                <div class="row">
                    <div class="col-4 mb-2 text-right pt-1 pr-1">No. Struk : </div>
    ...
    <div class="col-lg-9" id="print">
        ...
        <br>
        <div class="bg-total p-2 text-right print-none" style="font-size:35px;">
        ...
        <form method="POST" class="mt-2 print-none">
            <div class="row">
                ...
                <div class="col-lg-5 mb-2">
                    <textarea name="catatan" class="form-control form-control-sm" id="catatan_baru" placeholder="Catatan Transaksi (Jika Ada)" cols="2" rows="5" onchange="new_catatan()"></textarea>
                </div>
                <div class="col-lg-7 mb-2 print-none">
                    <div class="row">
                        <div class="col-5 mb-2 text-right pt-1 pr-2" style="font-weight:700; font-size:18px;">Pembayaran :</div>
                        <div class="col-7 mb-2 pl-0">
                            ...
                            <input type="number" class="form-control form-control-sm bg-white" placeholder="0" name="pembayaran" id="bayarnya" onchange="totalnya()" required style="font-size: 20px;">
                        </div>
                        <div class="col-5 text-right pt-1 pr-2" style="font-weight:700; font-size:18px;">Kembalian :</div>
                        <div class="col-7 pl-0">
                            <input type="text" class="form-control form-control-sm bg-white" placeholder="0" name="kembalian" id="total1" readonly style="font-size: 40px;">
                        </div>
                        <!-- <div class="col-12">
                            <div style="background-color:lightskyblue; padding: 10px; border-radius: 5px; display: flex; justify-content: space-between; align-items: center;">
                                <span style="font-weight: 500; font-size: 18px; ">Kembalian :</span>
                                <span style="font-size: 24px;  font-weight: 700;">Rp. <span id="total1" name="kembalian">0</span></span>
                            </div>
                        </div> -->
                    </div>
