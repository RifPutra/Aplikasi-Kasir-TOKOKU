            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editP<?php echo $idproduk ?>">
                                <i class="fa fa-pen fa-xs mr-1"></i>Edit</button>
                            <a class="btn btn-danger btn-xs" href="?hapus=<?php echo $idproduk ?>" onclick="javascript:return confirm('Hapus Data produk - <?php echo $d['nama_produk'] ?> ?');">
                                ...
                                <form method="post">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" name="kode_produk" class="form-control" value="<?php echo $d['kode_produk'] ?>" required>
                                        </div>
                                        <div class="form-group mb-2">
        ...
        <div class="modal-content">
            <form method="post">
                ...
                <div class="modal-body">
                    <div class="form-group mb-2">
                        <label>Kode Produk :</label>
                        <input type="text" name="kode_produk" class="form-control" value="<?php echo $kodeBarang; ?>" required>
                    </div>
                    <div class="form-group mb-2">
                        <label>Nama Produk :</label>
