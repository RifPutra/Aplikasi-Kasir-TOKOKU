            ...
            <div class="row">
                <div class="col-12 col-lg-2 m-pr-0">
                    ...
                    <div class="input-group">
                        <input type="text" name="kode_produk" class="form-control form-control-sm border-right-0" list="datalist1" onchange="changeValue(this.value)" aria-describedby="basic-addon2" required>
                ...
                <div class="col-8 col-lg-2 pr-0">
                    ...
                    <input type="number" class="form-control form-control-sm bg-white" id="harga_jual" value="<?php echo $row_brg['harga_jual']; ?>" name="harga_jual" onchange="total()">
                </div>
                <div class="col-4 col-lg-2 m-pr-0">
                    <label class="mb-1">Qty</label>
                    <input type="number" class="form-control form-control-sm" id="quantity" onchange="total()" name="quantity" placeholder="0">
                </div>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger btn-xs" href="?hapus=<?php echo $idkategori ?>" onclick="javascript:return confirm('Hapus Data produk - <?php echo $d['nama_kategori'] ?> ?');">
